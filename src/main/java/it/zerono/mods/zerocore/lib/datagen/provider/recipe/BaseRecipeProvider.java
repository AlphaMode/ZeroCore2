...
public abstract class BaseRecipeProvider
    ...
    protected void blasting(final Consumer<FinishedRecipe> consumer, final String name,
        ...
        conditionalBuilder(conditions)
                .addRecipe(SimpleCookingRecipeBuilder.blasting(Ingredient.of(source.get()), result.get(), xp, time)
    ...
    protected void storageBlock3x3(final Consumer<FinishedRecipe> consumer, final String name,
                                   final NonNullFunction<String, ResourceLocation> nameToIdConverter,
                                   final String group, final Supplier<? extends ItemLike> component,
    ...
    protected void storageBlock2x2(final Consumer<FinishedRecipe> consumer, final String name,
                                   final NonNullFunction<String, ResourceLocation> nameToIdConverter,
                                   final String group, final Supplier<? extends ItemLike> component,
                                   final Supplier<? extends ItemLike> storage) {
